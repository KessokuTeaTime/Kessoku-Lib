...
/**
 * A default serializer that writes in the <a href="https://yaml.org/">YAML format</a>.
 *
...
public final class YamlSerializer implements Serializer {
    ...
    private final ConfigParser<com.electronwill.nightconfig.core.Config> parser = new YamlParser();
    private final ConfigWriter writer = new YamlWriter();
