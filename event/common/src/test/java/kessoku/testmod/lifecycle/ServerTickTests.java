...
import band.kessoku.lib.api.event.TickEvents;
...
public class ServerTickTests implements KessokuModInitializer {
    ...
    public void onInitialize() {
        TickEvents.START_WORLD_TICK.register(world -> {
        ...
        TickEvents.END_WORLD_TICK.register(world -> {
        ...
        TickEvents.START_SERVER_TICK.register(server -> {
            KessokuTestLifecycle.LOGGER.info("Server tick started");
        });

        TickEvents.END_SERVER_TICK.register(server -> {
